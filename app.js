...
const back = () => {
    if (document.querySelector('.main-shop').classList.contains('hide')) {
        document.querySelector('.display').classList.add('hide')
    } else if(!document.querySelector('.confirm-purchase-cont').classList.contains('hide') || !document.querySelector('.cancel-purchase-cont').classList.contains('hide')){
        cancelPopUp()
    } else {
